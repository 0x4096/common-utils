package com.github.Is0x4096.common.utils.jar;

/**
 * @author: 0x4096.peng@gmail.com
 * @date: 2018/12/20
 * @instructions: 为避免jar冲突，比如hbase可能有多个版本的读写依赖jar包，JobContainer和TaskGroupContainer
 * 就需要脱离当前classLoader去加载这些jar包，执行完成后，又退回到原来classLoader上继续执行接下来的代码
 * 参考代码: https://github.com/Arvin-Mark/DataX-src/blob/5bc8382de7/core/src/main/java/com/alibaba/datax/core/util/container/ClassLoaderSwapper.java
 */
