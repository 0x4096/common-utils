package com.github.x4096.common.utils.data.redis;
 ...
 * @DateTime: 2019-07-19 23:38
 * @Description: 参考: https://github.com/whvcse/RedisUtil/blob/master/RedisUtil.java
 */
public class JedisTemplate {
    ...
    public static void main(String[] args) {
        ...
        // RedisNode redisNode1 = new RedisNode("172.16.139.128", 7000);
        // RedisNode redisNode2 = new RedisNode("172.16.139.128", 7001);
        // RedisNode redisNode3 = new RedisNode("172.16.139.128", 7002);
        // RedisNode redisNode4 = new RedisNode("172.16.139.128", 7003);
        // RedisNode redisNode5 = new RedisNode("172.16.139.128", 7004);
        // RedisNode redisNode6 = new RedisNode("172.16.139.128", 7005);
        //
        ...
        res = stringRedisTemplate.opsForValue().setIfAbsent("key", "value", 10, TimeUnit.SECONDS);
        System.err.println(res);

        res = stringRedisTemplate.opsForValue().setIfAbsent("key", "value", 1000, TimeUnit.SECONDS);
        System.err.println(res);
